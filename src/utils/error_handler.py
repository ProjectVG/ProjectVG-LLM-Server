...
class ErrorHandler:
    ...
    @staticmethod
    def handle_chat_service_error(exception: ChatServiceException, session_id: str = "") -> ChatResponse:
        """채팅 서비스 에러 처리"""
    ...
    @staticmethod
    def handle_openai_client_error(exception: OpenAIClientException, session_id: str = "") -> ChatResponse:
        """OpenAI 클라이언트 에러 처리"""
    ...
    @staticmethod
    def handle_validation_error(exception: ValidationException, session_id: str = "") -> ChatResponse:
        """검증 에러 처리"""
    ...
    @staticmethod
    def handle_configuration_error(exception: ConfigurationException, session_id: str = "") -> ChatResponse:
        """설정 에러 처리"""
    ...
    @staticmethod
    def handle_generic_error(exception: Exception, session_id: str = "") -> ChatResponse:
        """일반 에러 처리"""
    ...
    @staticmethod
    def handle_api_error(exception: Exception, session_id: str = "") -> HTTPException:
